    ...
    public class Water : MonoBehaviour
    {
        ...
        void CreateWaterObjects(Camera currentCamera, out Camera reflectionCamera, out Camera refractionCamera)
        {
            ...
            if (mode >= WaterMode.Reflective)
            {
                ...
                if (!reflectionCamera) // catch both not-in-dictionary and in-dictionary-but-deleted-gameObject
                {
            ...
            if (mode >= WaterMode.Refractive)
            {
                ...
                if (!refractionCamera) // catch both not-in-dictionary and in-dictionary-but-deleted-gameObject
                {
                    GameObject gameObject =
                        new GameObject("Water Refr Camera id" + GetInstanceID() + " for " + currentCamera.GetInstanceID(),
                            typeof(Camera), typeof(Skybox));
                    refractionCamera = gameObject.GetComponent<Camera>();
